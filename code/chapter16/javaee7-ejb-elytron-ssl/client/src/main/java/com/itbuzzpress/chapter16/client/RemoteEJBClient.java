...
public class RemoteEJBClient {
	...
	private static Account lookupAccountEJB() throws NamingException {
		...
		return (Account) context
				.lookup("ejb:/javaee7-ejb-server-elytron-ssl/AccountEJB!com.itbuzzpress.chapter16.ejb.Account?stateful");
	}
	...
	private static Calculator lookupCalculatorEJB() throws NamingException {
		...
		return (Calculator) context
				.lookup("ejb:/javaee7-ejb-server-elytron-ssl/CalculatorEJB!com.itbuzzpress.chapter16.ejb.Calculator");
	}
}
